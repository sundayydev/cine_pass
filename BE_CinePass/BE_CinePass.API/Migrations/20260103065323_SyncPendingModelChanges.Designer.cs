...
namespace BE_CinePass.API.Migrations
{
    ...
    [Migration("20260103065323_SyncPendingModelChanges")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BE_CinePass.Domain.Models.MemberPoint", b =>
                {
                    ...
                    b.Property<DateTime?>("NextExpiryDate")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("next_expiry_date");

                    b.Property<int>("Points")
                        .HasColumnType("integer")
                        .HasColumnName("points");

                    b.Property<int>("PointsToExpire")
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("BE_CinePass.Domain.Models.MemberTierConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("BE_CinePass.Domain.Models.UserVoucher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("BE_CinePass.Domain.Models.Voucher", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("QuantityRedeemed")
                        .HasColumnType("integer")
                        .HasColumnName("quantity_redeemed");
            ...
            modelBuilder.Entity("BE_CinePass.Domain.Models.Order", b =>
                {
                    ...
                    b.HasOne("BE_CinePass.Domain.Models.UserVoucher", "UserVoucher")
                        .WithMany()
            ...
            modelBuilder.Entity("BE_CinePass.Domain.Models.PointHistory", b =>
                {
                    ...
                    b.HasOne("BE_CinePass.Domain.Models.Voucher", "Voucher")
                        .WithMany()
            ...
            modelBuilder.Entity("BE_CinePass.Domain.Models.UserVoucher", b =>
                {
                    b.HasOne("BE_CinePass.Domain.Models.Order", "Order")
                        .WithOne()
                        .HasForeignKey("BE_CinePass.Domain.Models.UserVoucher", "OrderId")
                        .OnDelete(DeleteBehavior.SetNull);
